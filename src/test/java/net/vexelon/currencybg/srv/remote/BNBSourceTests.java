...
public class BNBSourceTests {
	...
	public void testEN() {
		try {
			List<CurrencyData> rates = new BNBSource().getRates(getTestResource("/exchange_rates_en.xml"));
			assertTrue(rates.get(0).getName().equals("Australian Dollar"));
			...
			assertTrue(rates.get(0).getCurrDate().equals(newDate(2016, 3, 15))); // 15.03.2016
			assertTrue(rates.get(0).getfStar() == 0);

			assertTrue(rates.get(3).getName().equals("Swiss Franc"));
			...
			assertTrue(rates.get(3).getCurrDate().equals(newDate(2016, 3, 15))); // 15.03.2016
			assertTrue(rates.get(3).getfStar() == 0);

			assertTrue(rates.get(14).getName().equals("Icelandic Krona *"));
			...
			assertTrue(rates.get(14).getCurrDate().equals(newDate(2016, 3, 15))); // 15.03.2016
			assertTrue(rates.get(14).getfStar() == 1);

			int pos = rates.size() - 1;
			assertTrue(rates.get(pos).getName().equals("Gold (1 troy ounce)"));
			...
			assertTrue(rates.get(pos).getCurrDate().equals(newDate(2016, 3, 15))); // 15.03.2016
	...
	public void testBG() {
		try {
			List<CurrencyData> rates = new BNBSource().getRates(getTestResource("/exchange_rates_bg.xml"));
			...
			assertTrue(rates.get(0).getCurrDate().equals(newDate(2016, 3, 11))); // 11.03.2016
			assertTrue(rates.get(0).getfStar() == 0);
			...
			assertTrue(rates.get(3).getCurrDate().equals(newDate(2016, 3, 11))); // 11.03.2016
			assertTrue(rates.get(3).getfStar() == 0);
			...
			assertTrue(rates.get(14).getReverseRate().equals("0"));
			assertTrue(rates.get(14).getRate().equals("0"));
			assertTrue(rates.get(14).getCurrDate().equals(newDate(2016, 3, 11))); // 11.03.2016
			assertTrue(rates.get(14).getfStar() == 1);
			...
			assertTrue(rates.get(pos).getCurrDate().equals(newDate(2016, 3, 11))); // 11.03.2016
			assertTrue(rates.get(pos).getfStar() == 0);
