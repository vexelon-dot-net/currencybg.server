...
public class DateTimeUtilsTests {
	...
	public void test_Convert_TimeZone() {
		...
		try {
			assertTrue(DateTimeUtils
					.toTimeZone("2016-07-16T21:40:06+0200", Defs.CURRENT_TIME_ZONE, Defs.DATETIME_ZONE_FORMAT)
	...
	// try {
	// assertTrue(DateTimeUtils
	// .modifyDateLayout("2016-07-16T22:40:06+0300", Defs.DATETIME_ZONE_FORMAT,
